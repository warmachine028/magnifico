...
const Community = () => {
	return (
		<section id="community" className="container sm:px-2 mx-auto mt-52 bg-gradient-to-r from-blue-700 to-purple-900 flex-col justify-center sm:rounded-xl items-center sm:pt-0 sm:pb-0 pt-10 pb-10">
