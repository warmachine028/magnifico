...
const Community = () => {
	return (
		<section id="community" className="container mx-auto mt-36 flex-col items-center justify-center bg-gradient-to-r from-blue-700 to-purple-900 py-14 sm:mt-52 sm:rounded-xl sm:px-2 sm:pb-0 sm:pt-0">
