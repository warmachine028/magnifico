...
const PaymentMode = () => {
	return (
		<section id="payment-mode" className="my-8">
			<h6 className="mt-10 text-2xl font-medium sm:text-3xl">Select your mode of payment</h6>
			<p className="py-5 text-lg font-light text-gray-700 sm:text-xl">Payments with Tickets are secure and encrypted.</p>
