			...
			<form className="pt-8">
				...
				<div className="flex flex-row pt-4 gap-4">
					<div className="relative w-1/2">
						...
						<select type="text" id="input-group-1" className="w-full ps-10 text-gray-400  ring-1 ring-gray-300 rounded-2xl px-4 h-14" defaultValue="Country code" required>
					...
					<div className="relative w-1/2">
						...
						<input type="number" className="w-full ps-10 text-gray-400  ring-1 ring-gray-300 rounded-2xl px-4 h-14" placeholder="Phone number" autoComplete="tel" required />
					</div>
				</div>
