			...
			<div className="sm:w-1/2 w-full justify-center sm:mx-10 flex flex-col px-7">
				<div className="sm:w-[550px]">
					...
					<form className="mt-5 mb-5 flex gap-3">
						<input placeholder="Enter work email" className="border pl-12 sm:w-full w-1/2 h-12 border-gray-300 placeholder-gray-700 rounded-lg bg-no-repeat" style={{ backgroundImage: `url('${EnvelopeIcon}')`, backgroundPosition: '15px' }} />
