...
const ProblemSolved = () => {
	return (
		<section style={{backgroundImage: `url('${Container}')`}} className="container px-2 mx-auto mt-48 bg-my-image bg-no-repeat w-full h-[550px] bg-center sm:rounded-3xl bg-cover flex text-white items-center">
