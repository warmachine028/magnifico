...
const PaymentOption = ({ children, name, icon, disabled, defaultChecked }) => {
	return (
		<label className="cursor-pointer">
			...
			<div className="group relative my-5 cursor-pointer rounded-2xl bg-gray-100 px-7 py-5 ring-1 ring-gray-300 transition-all delay-700 peer-checked:bg-white peer-checked:ring-gray-700 peer-disabled:cursor-not-allowed">
