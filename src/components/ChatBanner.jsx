...
const ChatBanner = () => {
	return (
		<div className="sm:w-2/5 sm:max-w-md">
			...
			<div className="my-8 flex items-center justify-between rounded-2xl bg-gray-100 px-7 py-4">
				<div>
					<h6 className="mt-5 max-w-40 font-semibold tracking-wide">Still need help? We're here for you</h6>
