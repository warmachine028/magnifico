		...
		<label className="cursor-pointer">
			...
			<div className="group my-4 items-center gap-4 rounded-2xl p-6 ring-1 ring-gray-300 peer-checked:ring-gray-500">
				<div className="flex items-center gap-4">
					<FiPlus className="size-6 text-gray-500 peer-checked:group-[]:hidden" />
					<FiPlus className="hidden size-6 rotate-45 text-gray-500 transition-all delay-150 ease-in-out peer-checked:group-[]:flex" />
