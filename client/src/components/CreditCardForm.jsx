		...
		<form>
			<div className="flex items-center gap-4">
				<label className="my-6 flex h-6 w-12 cursor-pointer items-center justify-center rounded-md ring-1 ring-gray-400 transition-colors has-[:checked]:bg-blue-200 has-[:checked]:ring-black">
					<input type="radio" name="selectcard" className="peer sr-only" />
			...
			<div>
				<div className="flex flex-col gap-4 pt-4">
					...
					<div className="flex flex-col gap-4 sm:flex-row sm:pt-4">
						<div className="relative w-full sm:w-1/2">
							...
							<input
								className="h-14 w-full rounded-2xl bg-transparent px-4 ps-10 text-gray-400 ring-1 ring-gray-400"
				...
				<hr className="my-8" />
				<div className="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-between dark:text-white">
				...
				<div className="mt-4 flex justify-center sm:justify-start">
					<button
						type="submit"
						className="my-6 flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-600 px-10 py-4 text-lg font-semibold text-white shadow-md sm:flex sm:w-max"
					>
						<MdLock />
						Confirm & pay
					</button>
