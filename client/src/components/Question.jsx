...
const Question = ({ ques, ans, defaultChecked }) => {
	return (
		<label className="cursor-pointer">
			...
			<div className="duration-600 peer-checked: group my-4 items-center gap-4 rounded-2xl p-6 ring-1 ring-gray-300 transition-all peer-checked:ring-gray-500 dark:bg-gray-300">
				<div className="flex items-center gap-4">
					<FiPlus className="duration-600 size-6 text-gray-500 transition-all ease-in-out peer-checked:group-[]:rotate-45" />
					<h6 className="font-semibold dark:text-gray-700">{ques}</h6>
				</div>
