...
const PaymentHero = () => {
	return (
		<section id="payment-hero" className="sm:my-8 dark:bg-slate-900">
			<h1 className="font-robotoserif text-3xl font-medium sm:font-sans sm:text-6xl sm:font-extrabold dark:text-blue-700">
				Confirm & pay
			</h1>
			...
			<div className="my-16 flex items-center justify-between rounded-2xl p-5 ring-1 ring-gray-300">
				<h6 className="text-sm text-gray-600 sm:text-lg">
					<strong className="text-black sm:font-semibold dark:text-white">Free cancellation</strong>
					<br />
				...
				<div className="group relative">
					...
					<span className="sidebar-tooltip origin left absolute bottom-3 m-2 w-auto min-w-max scale-0 rounded-md bg-gray-100 p-2 text-xs font-medium text-gray-600 shadow-md transition-all duration-100 group-hover:scale-100">
						More info
					</span>
				</div>
			</div>
